...
class UsuarioControllerTest {
	...
	void start() {
		...
		usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null, BASE_URL, ADMIN, SENHA));
	}
	...
	void deveCadastrarUsuario() {
		...
		//Given
		Usuario usuario = TestBuilder.criarUsuario(null,  "Paulo Antunes", "paulo_antunes@email.com", "12345678");
	...
	void naoDeveDuplicarUsuario() {
		...
		//Given
		Usuario usuario = TestBuilder.criarUsuario(null, "Maria Silva", "maria_silva@email.com", "12345678");
	...
	void deveListarTodosUsuarios() {
		...
		//Given
		usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null,  "Mia Santana", "mia_santana@email.com", "12345678"));
		usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null, "Carlos Moura", "carlos_moura@email.com", "12345678"));
	...
	void deveListarUsuarioPorId() {
		...
		//Given
		usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null, "Day Santana", "day_santana@email.com", "12345678"));
		usuarioService.cadastrarUsuario(TestBuilder.criarUsuario(null, "Felipe Prado", "felipe_prado@email.com", "12345678"));
		
		//When
		String token = JwtHelper.obterToken(testRestTemplate, ADMIN, SENHA);
		HttpEntity<Void> requisicao = JwtHelper.criarRequisicaoComToken(token);
		ResponseEntity<Usuario> resposta = testRestTemplate.exchange(
				BASE_URL + "/1", HttpMethod.GET, requisicao, Usuario.class);
